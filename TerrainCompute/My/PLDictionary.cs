...
{
    //存储点和以这个点为端点的直线
    public class PLDictionary:Dictionary<Point3d,List<Autodesk.AutoCAD.DatabaseServices.Line>>
    {
        public void Add(List<Line> ll)
        {
            if (ll == null) return;
        ...
        public void Add(Point3d p,Line l){
            List<Autodesk.AutoCAD.DatabaseServices.Line> llist = null;
            ...
            {
                llist = new List<Autodesk.AutoCAD.DatabaseServices.Line>();
                llist.Add(l);
                base.Add(p, llist);
            }
        }
        ...
        public Vector2d? getStartVector(Point3d? startP)
        {
            ...
            {                
                ...
                List<Line> ll = this[leftMostPoint.Value];
                Vector2d? v=null;
                //Point3d? p=null;
