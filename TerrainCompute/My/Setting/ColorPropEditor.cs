...
namespace TerrainComputeC.My
{
    ...
    public partial class ColorPropEditor : System.Drawing.Design.UITypeEditor
    {
        ...
        public override object EditValue(System.ComponentModel.ITypeDescriptorContext context, System.IServiceProvider provider, object value)
        {
            ...
            if (value.GetType() != typeof(ColorProp))
                return value;
            ...
            {
                // 显示编辑框并初始化编辑框的值
                ColorPropControl angleControl = new ColorPropControl((ColorProp)value);
                edSvc.ShowDialog(angleControl);
                // 返回编辑框中编辑的值.
                if (value.GetType() == typeof(ColorProp))
                    return angleControl.CP;
            }
            return value;
        }
