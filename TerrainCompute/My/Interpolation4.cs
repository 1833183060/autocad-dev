...
namespace TerrainComputeC.My
{
    public class Interpolation4
    {
        ...
        internal static ProjectClass4 getMovement(Point3d p, Point3d p1, Point3d p2, Point3d p3)
        {
            ...
            return new ProjectClass4(plane1,prjMat1,direction,pl) ;
        }
    ...
    internal class ProjectClass4
    {
        ...
        internal ProjectClass4(Autodesk.AutoCAD.Geometry.Plane p, Autodesk.AutoCAD.Geometry.Matrix3d m, Autodesk.AutoCAD.Geometry.Vector3d d, List<Point3d> pl)
        {
            plane = p; prjMat = m; direction = d; points = pl;
        }
    }

    internal class Movement4
    {
        internal double dis;
        internal Autodesk.AutoCAD.Geometry.Vector3d move;
        internal Movement4(double d, Autodesk.AutoCAD.Geometry.Vector3d m)
        {
            dis = d; move = m;
        }
        internal Movement4()
