...
namespace TerrainComputeC.BASE
{
	...
	public class IO
	{
		static IO()
		{
			IO.string_0 = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "entities.xml");
			IO.string_1 = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "entities.xml");
			IO.string_2 = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "faces.3df");
			IO.string_3 = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "faces.3df");
			IO.string_4 = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "points.xyz");
			IO.string_5 = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "points.xyz");
			IO.string_6 = "S";
			IO.string_7 = DBManager.CurrentLayerName();
			IO.string_8 = "N";
			IO.string_9 = "S";
			IO.int_0 = 9;
			IO.int_1 = 4;
		...
		public IO()
		{
            ////System.ComponentModel.LicenseManager.Validate(typeof(IO));
			//base..ctor();
		}
		...
		[CommandMethod("TCPlugin", "ng:IO:3DFIN", 0)]
		public void IN3DF()
		{
			try
			{
				////LicenseManager.CheckValid("FULL");
				CommandLineQuerries.SpecifyFileNameForRead(ref IO.string_3, "3df");
				this.method_2();
			}
            catch (System.Exception ex)
			{
		...
		{
            Editor editor = Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument.Editor;
			editor.WriteMessage("\nReading xml file " + IO.string_1 + "...");
			EntityList entityList = Serializer.Deserialize(IO.string_1);
		...
		{
			string format = this.method_7(IO.int_1);
			string text = this.method_6();
			...
			if (IO.int_0 > 0)
			{
				text2 = text2.PadLeft(IO.int_0);
				text3 = text3.PadLeft(IO.int_0);
				text4 = text4.PadLeft(IO.int_0);
				if (text2.Length > IO.int_0)
				{
					text2 = text2.Remove(0).PadLeft(IO.int_0, '*');
					int_2++;
				}
				if (text3.Length > IO.int_0)
				{
					text3 = text3.Remove(0).PadLeft(IO.int_0, '*');
					int_2++;
				}
				if (text4.Length > IO.int_0)
				{
					text4 = text4.Remove(0).PadLeft(IO.int_0, '*');
					int_2++;
				}
			}
		...
		[CommandMethod("TCPlugin", "ng:IO:3DFOUT", 0)]
		public void OUT3DF()
		{
            Editor editor = Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument.Editor;
			ObjectId[] array = null;
			...
			{
				////LicenseManager.CheckValid("FULL");
				IO.string_6 = CommandLineQuerries.SpecifyEntitiesBySelectionOrByLayer(IO.string_6);
				if (IO.string_6 == "S")
				{
					array = CommandLineQuerries.SelectFaces(true);
				}
				else if (IO.string_6 == "L")
				{
					IO.string_7 = CommandLineQuerries.SpecifyLayerName(IO.string_7);
					if (!DBManager.ExistsLayer(IO.string_7))
					{
						throw new ArgumentException("Layer does not exist.");
					}
					array = DBManager.GetFacesOnLayer(IO.string_7);
					if (array == null)
					{
				...
				CommandLineQuerries.SpecifyFileNameForWrite(ref IO.string_2, ref IO.string_8, "3df");
				IO.string_9 = CommandLineQuerries.SpecifyDelimiter(IO.string_9);
				IO.int_0 = CommandLineQuerries.SpecifyColumnWidth(IO.int_0);
				IO.int_1 = CommandLineQuerries.SpecifyDecimalDigits(IO.int_1);
				this.method_3(array);
			}
            catch (System.Exception ex)
			{
		...
		[CommandMethod("TCPlugin", "ng:IO:XMLIN", 0)]
		public void XMLIN()
		{
			try
			{
				////LicenseManager.CheckValid("FULL");
				CommandLineQuerries.SpecifyFileNameForRead(ref IO.string_1, "xml");
				this.method_0();
			}
            catch (System.Exception ex)
			{
		...
		[CommandMethod("TCPlugin", "ng:IO:XMLOUT", 0)]
		public void XMLOUT()
		{
			try
			{
				...
				CommandLineQuerries.SpecifyFileNameForWrite(ref IO.string_0, ref IO.string_8, "xml");
		...
		[CommandMethod("TCPlugin", "NG:IO:XYZIN", 0)]
		public void XYZIN()
		{
			try
			{
				////LicenseManager.CheckValid("FULL");
				CommandLineQuerries.SpecifyFileNameForRead(ref IO.string_4, "xyz");
				this.method_4();
			}
            catch (System.Exception ex)
			{
		...
		[CommandMethod("TCPlugin", "ng:IO:XYZOUT", 0)]
		public void XYZOUT()
		{
            Editor editor = Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument.Editor;
			ObjectId[] array = null;
			try
			{
				...
				else if (IO.string_6 == "L")
				{
					...
					array = DBManager.GetPointsOnLayer(IO.string_7);
					if (array == null)
					{
				...
				CommandLineQuerries.SpecifyFileNameForWrite(ref IO.string_5, ref IO.string_8, "xyz");
				IO.string_9 = CommandLineQuerries.SpecifyDelimiter(IO.string_9);
				IO.int_0 = CommandLineQuerries.SpecifyColumnWidth(IO.int_0);
				IO.int_1 = CommandLineQuerries.SpecifyDecimalDigits(IO.int_1);
				this.WriteXYZ(array);
