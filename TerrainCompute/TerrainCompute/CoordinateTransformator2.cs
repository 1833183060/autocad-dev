...
namespace TerrainComputeC
{
	...
	public class CoordinateTransformator2
	{
		...
		public CoordinateTransformator2 GetInverseTransformation()
		{
			return new CoordinateTransformator2(this.coordinateSystem_1, this.coordinateSystem_0);
		}
