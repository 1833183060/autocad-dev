...
{	
	public class MenuLoader : IExtensionApplication
	{
		public MenuLoader()
		{            
			this.string_1 = "";
		...
		public void CreateNewMenu()
		{
			...
			{
				this.method_3();
				this.method_1(this.method_4(this.cuiPath));
			}
		...
		private void method_1(string string_4)
		{
			...
			mdiActiveDocument.SendStringToExecute("_.cuiload " + string_4 + " ", false, false, false);
		...
		private const string string_0 = "TCPlugin";

		private string string_1;

		private string string_2;

		private string cuiPath;
	}
}
