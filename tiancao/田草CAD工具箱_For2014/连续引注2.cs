			...
			checked
			{
				...
				if (value != this.point3d_1)
				{
					...
					for (;;)
					{
						...
						this.double_2 = Math.Min(this.point3d_2[num3].Y, this.double_2);
						this.double_1 = Math.Max(this.point3d_2[num3].Y, this.double_1);
						point3d..ctor(value.X, this.point3d_2[num3].Y, 0.0);
					...
					unchecked
					{
						Point3d point3d2;
						Point3d pointAngle;
						if (this.double_2 > value.Y)
						{
							point3d..ctor(value.X, this.double_2 - 1000.0 * this.double_0, 0.0);
							point3d2..ctor(value.X, this.double_1, 0.0);
							pointAngle = CAD.GetPointAngle(point3d, 50.0 * this.double_0, 90.0);
						}
						else
						{
							point3d..ctor(value.X, this.double_1 + 1000.0 * this.double_0, 0.0);
							point3d2..ctor(value.X, this.double_2, 0.0);
							pointAngle..ctor(value.X, this.double_1, 0.0);
